...
import { UtensilsCrossedIcon, BowlHotIcon } from "lucide-react";
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="flex flex-col items-center justify-center p-6 border border-gray-200 rounded-lg hover:shadow-md transition-shadow">
            ...
            <p className="text-gray-600 text-center text-sm">Khám phá ẩm thực châu Âu đích thực và các món đặc sản địa phương</p>
          </div>
          ...
          <div className="flex flex-col items-center justify-center p-6 border border-gray-200 rounded-lg hover:shadow-md transition-shadow">
            ...
            <p className="text-gray-600 text-center text-sm">Thưởng thức hương vị quê nhà với các món ăn Á - Việt tại châu Âu</p>
          </div>
        </motion.div>
      </div>
    </section>

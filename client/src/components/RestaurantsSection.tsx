...
import { UtensilsCrossed, Beef, Bowl } from "lucide-react";
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="flex flex-col items-center justify-center p-6 border border-gray-200 rounded-lg hover:shadow-md transition-shadow">
            ...
            <p className="text-gray-600 text-center text-sm">Khám phá tinh hoa ẩm thực châu Âu và đặc sản địa phương</p>
          </div>

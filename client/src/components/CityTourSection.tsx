                ...
                <CarouselItem key={index} className="md:basis-1/2 lg:basis-1/3">
                  <div className="relative h-full bg-white rounded-lg shadow-md overflow-hidden flex flex-col">
                    ...
                    <div className="p-4 flex flex-col flex-grow">
                      ...
                      <div className="mb-4">
                        <p className="text-gray-600 text-sm leading-5">{tour.duration}</p>
                        <p className="text-gray-600 text-sm leading-5">{tour.transport}</p>
                        <p className="text-gray-600 text-sm leading-5">{tour.buddy}</p>
                      </div>
